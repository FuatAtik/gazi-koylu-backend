...
namespace Taigate.Core
{
    ...
    public partial class WebHelper : IWebHelper
    {
        ...
        private readonly ITaigateFileProvider _fileProvider;
        ...
        public WebHelper(IActionContextAccessor actionContextAccessor,
            ...
            ITaigateFileProvider fileProvider,
        ...
        /// <summary>
        /// BU METHOD TRUE DÖNER
        /// </summary>
        /// <returns></returns>
        protected virtual bool TrueReturner()
        {
            return true;
        }
        ...
        public virtual string GetCurrentIpAddress()
        {
            ...
            try
            {
                ...
                if (_httpContextAccessor.HttpContext.Request.Headers != null)
                {
                    ...
                    var forwardedHttpHeaderKey = TaigateDefaults.XForwardedForHeader;
        ...
        public virtual bool IsCurrentConnectionSecured()
        {
            ...
            //     return _httpContextAccessor.HttpContext.Request.Headers[TaigateDefaults.HttpClusterHttpsHeader]
            //         .ToString().Equals("on", StringComparison.OrdinalIgnoreCase);
            //
            // //use HTTP_X_FORWARDED_PROTO?
            // if (_hostingConfig.UseHttpXForwardedProto)
            //     return _httpContextAccessor.HttpContext.Request.Headers[TaigateDefaults.HttpXForwardedProtoHeader]
        ...
        public virtual string GetStoreHost(bool useSsl)
        {
            ...
            var storeHost =
                $"{(useSsl ? Uri.UriSchemeHttps : Uri.UriSchemeHttp)}{Uri.SchemeDelimiter}{hostHeader.FirstOrDefault()}";
        ...
        public virtual string ModifyQueryString(string url, string key, params string[] values)
        {
            ...
            url =
                $"{(isLocalUrl ? uri.LocalPath : uri.GetLeftPart(UriPartial.Path))}{queryBuilder.ToQueryString()}{uri.Fragment}";
        ...
        public virtual string RemoveQueryString(string url, string key, string value = null)
        {
            ...
            var queryParameters = QueryHelpers.ParseQuery(uri.Query)
                .SelectMany(parameter => parameter.Value,
                    (parameter, queryValue) => new KeyValuePair<string, string>(parameter.Key, queryValue))
                .ToList();
        ...
        public virtual bool IsPostBeingDone
        {
            get
            {
                if (_httpContextAccessor.HttpContext.Items[TaigateDefaults.IsPostBeingDoneRequestItem] == null)
                    return false;

                return Convert.ToBoolean(
                    _httpContextAccessor.HttpContext.Items[TaigateDefaults.IsPostBeingDoneRequestItem]);
            }

            set => _httpContextAccessor.HttpContext.Items[TaigateDefaults.IsPostBeingDoneRequestItem] = value;
        }

        /// <summary>
        /// Gets current HTTP request protocol
        /// </summary>
        public virtual string CurrentRequestProtocol =>
            IsCurrentConnectionSecured() ? Uri.UriSchemeHttps : Uri.UriSchemeHttps;
