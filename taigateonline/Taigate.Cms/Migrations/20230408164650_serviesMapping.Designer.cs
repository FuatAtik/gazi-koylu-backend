...
namespace Taigate.Cms.Migrations
{
    ...
    [Migration("20230408164650_serviesMapping")]
    partial class serviesMapping
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Taigate.Data.Data.Entities.Components.GaziKoylu.ContactUsContent", b =>
                {
                    ...
                    b.Property<string>("EmailFontTitle")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("LocationFontTitle")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("PhoneNoFontTitle")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Taigate.Data.Data.Entities.Components.GaziKoylu.HomePageAboutSection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("AboutFeatures")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("HomePageAboutButtonText")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("HomePageAboutButtonUrl")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("HomePageAboutDescription")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("HomePageAboutImage")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("HomePageAboutTitle")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("HomePageAboutSection");
                });
            ...
            modelBuilder.Entity("Taigate.Data.Data.Entities.Components.GaziKoylu.Service", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Taigate.Data.Data.Entities.Components.GaziKoylu.ServiceDetailAttributeMapping", b =>
                {
                    b.HasOne("Taigate.Data.Data.Entities.Components.GaziKoylu.ServiceDetailAttributeList", "ServiceDetailAttributeList")
                        .WithMany("ServiceDetailAttributeMapping")
                        .HasForeignKey("ServiceDetailAttributeListId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Taigate.Data.Data.Entities.Components.GaziKoylu.Service", "Service")
                        .WithMany("ServiceDetailAttributeMapping")
            ...
            modelBuilder.Entity("Taigate.Data.Data.Entities.Components.GaziKoylu.Service", b =>
                {
                    b.Navigation("ServiceDetailAttributeMapping");
                });
