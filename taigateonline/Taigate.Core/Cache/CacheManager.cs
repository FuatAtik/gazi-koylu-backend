...
namespace Taigate.Core.Cache
{
    ...
    public class CustomMemoryCache : ICustomCache
    {
        ...
        private readonly ConcurrentDictionary<object, ICacheEntry> _cacheEntries =
        ...
        {
            return this._cacheEntries.Select(pair => new KeyValuePair<object, object>(pair.Key, pair.Value.Value))
                .GetEnumerator();
        }
    ...
    public static class MemoryCacheExtensions
    {
        ...
        public static async Task<TItem> GetOrCreateAsync<TItem>(this ICustomCache cache, object key,
